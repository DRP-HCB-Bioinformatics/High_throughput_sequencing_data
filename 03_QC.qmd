...
**PacBio** data can be very different, we have prepared a NanoPlot report for [PacBio data](https://bifx-core3.bio.ed.ac.uk/training/ASD/02_HTS/DataQC/PacBio_nanoplot/NanoPlot-report.html) for you to view. 
